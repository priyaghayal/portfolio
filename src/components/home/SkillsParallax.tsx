...
import { SiTypescript, SiCplusplus, SiSpringboot, SiNextdotjs, SiExpress, SiTailwindcss, SiMysql, SiMongodb, SiPostgresql, SiFirebase, SiGooglecloud, SiKubernetes, SiJenkins, SiPostman, SiTableau, SiPowerbi } from "react-icons/si";
...
const skills = {
  ...
  row2: [
    { title: "Tableau", icon: SiTableau, color: "#3178C6" },
    { title: "PowerBI", icon: SiPowerbi, color: "#3178C6" },
    { title: "React", icon: FaReact, color: "#61DAFB" },
    { title: "Node.js", icon: FaNodeJs, color: "#339933" },
    { title: "Angular", icon: FaAngular, color: "#DD0031" },
    { title: "MySQL", icon: SiMysql, color: "#6DB33F" },
  ],
  row3: [
