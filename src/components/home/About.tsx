      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              I&apos;m a passionate software engineer & data analyst with a Master&apos;s degree 
              in Software Technology from Hochschule fur technik Stuttgart and 3 years 
              of experience specializing in Python, SQL, and Tableau. I am dedicated to transforming 
              data into actionable insights and building efficient, data-driven solutions. 
              Currently, I am seeking opportunities in the tech industry to 
              contribute to impactful projects while continuously learning and innovating. 
            </motion.p>
