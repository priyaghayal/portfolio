...
<motion.div 
      ...
      >
        ...
        From data insights to actionable strategies, I craft solutions with precision.
        </p>
        ...
        <p className={`${spaceGrotesk.className} text-[10px] xs:text-xs sm:text-sm md:text-lg text-white/80 mt-0 mb-4 mx-auto tracking-wide font-light`}>Actively seeking Software Engineering & Data Analysis roles</p>
        <div className="flex justify-center gap-6">
          <motion.a
            href="https://github.com/priyaghayal"
            target="_blank"
          ...
          <motion.a
            href="https://www.linkedin.com/in/priya-ghayal/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
