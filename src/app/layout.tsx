...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `${basePath}/favicon.png`, type: 'image/svg+xml' },
      { url: `${basePath}/favicon.png`, type: 'image/svg+xml', sizes: 'any' }
    ],
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      <head>
        <link rel="icon" type="image/svg+xml" href={`${basePath}/favicon.png`} />
        <link rel="shortcut icon" type="image/svg+xml" href={`${basePath}/favicon.png`} />
        <link rel="apple-touch-icon" href={`${basePath}/favicon.png`} />
        <link rel="mask-icon" href={`${basePath}/favicon.png`} color="#8B5CF6" />
